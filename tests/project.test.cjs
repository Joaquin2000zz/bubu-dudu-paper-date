...
test('Platform controls expose a separate jump action from the kiss action',()=>{
 ...
 assert(html.includes('styles/main.css?v=touch-joystick-4')&&html.includes('src/game.js?v=touch-joystick-4'));
 assert(js.includes('function jump')&&js.includes('k==="j"||k==="x"'));
 assert(js.includes('updateJoystick')&&js.includes('mobileAction')&&js.includes('touchstart')&&js.includes('touchmove')&&js.includes('touchJoystickId')&&js.includes('findTouch')&&!js.includes('[...(e.changedTouches')&&js.includes('e.pointerId===joystickPointer')&&js.includes('touchJoystick=false;touchJoystickId=null'));
